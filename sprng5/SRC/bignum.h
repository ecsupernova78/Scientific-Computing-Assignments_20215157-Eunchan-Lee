...
BigNum operator ^ (const BigNum &, const BigNum &);
BigNum operator ^ (const BigNum &, const unsigned long int);
unsigned long int operator & (const BigNum &,const unsigned long int);
...
BigNum b_powm (const BigNum &, const BigNum &,const BigNum &);
BigNum b_powm (const BigNum &, const unsigned int,const BigNum &);
...
unsigned long int SmallerSize (const BigNum &,const BigNum &);
unsigned long int BiggerSize (const BigNum &,const BigNum &);
...
unsigned long int CeilDiv (unsigned long int,unsigned long int);
